...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var kolorRed = findViewById<Button>(R.id.ZmienKolorRed)
        var kolorGreen = findViewById<ToggleButton>(R.id.toggleButtonGreen)
       mojPrzycisk.setOnClickListener{
        mojPrzycisk.setImageResource(R.drawable.bmw1)

        }

        val bitmap = BitmapFactory.decodeResource(resources, R.drawable.felis_catus_cat_on_snow)
